...
public class Question_2 {
	...
	public Question_2(double[][] in) {
		...
		/*
		 * int L=in.length; int c= in[0].length;
		 * 
		 * this.T = new double [L][c]; for (int lig=0;lig<this.T.length;lig++) { for
		 * (int col=0;col<this.T[lig].length;col++) { this.T[lig][col]=in[lig][col];
		 * 
		 * } }
		 * 
		 */
